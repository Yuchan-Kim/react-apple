...
function PurchasePage() {
  ...
  const fetchProductData = (detailNum) => {
    // 제품 기본 정보 가져오기
    axios.get(`http://localhost:9000/api/product/${detailNum}/info`)
      .then(response => {
        ...
        if (productName.includes('pro')) {
          // pro가 포함된 제품 호출
          axios.get(`http://localhost:9000/api/product/${detailNum}/anotherPro`)
          .then(response => {
          ...
          // se가 포함된 제품 호출
          axios.get(`http://localhost:9000/api/product/${detailNum}/anotherSe`)
          .then(response => {
          ...
          axios.get(`http://localhost:9000/api/product/${detailNum}/anotherRegular`)
          .then(response => {
    ...
    // 제품 이미지 가져오기
    axios.get(`http://localhost:9000/api/product/${detailNum}/productimages`)
      .then(response => {
    ...
    // 추가 이미지 가져오기
    axios.get(`http://localhost:9000/api/product/${detailNum}/infoImages`)
      .then(response => {
    ...
    // 색상 가져오기
    axios.get(`http://localhost:9000/api/product/${detailNum}/colors`)
      .then(response => {
    ...
    // 용량 가져오기
    axios.get(`http://localhost:9000/api/product/${detailNum}/storages`)
      .then(response => {
